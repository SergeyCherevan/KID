...
namespace KID.Services.CodeExecution.Compilation
{
    ...
    /// <see cref="System.Console.Clear"/> в WPF-консоль KID. Между проходами создаётся новая
    ...
    public class CSharpCompiler : ICodeCompiler
    {
        ...
        /// преобразование System.Console.Clear → генерация сборки → результат. Ошибки пользовательской
