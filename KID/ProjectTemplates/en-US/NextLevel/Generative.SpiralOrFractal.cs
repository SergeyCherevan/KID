...
// Generative drawing (spiral).
// What this teaches: loops, math (sin/cos), parameters, experimentation.
//
// Controls:
// - Space = redraw
// - Up/Down = change point count
// - Left/Right = change spiral tightness
// - Esc = exit

int points = 1200;
double turns = 10; // how many rotations
...
void Draw()
{
    ...
    // gradient-ish palette by changing color every N steps
    ...
    Graphics.Text(10, 10, $"Generative spiral  points={points}  turns={turns}");
    Graphics.Text(10, 30, "Space=redraw  Up/Down=points  Left/Right=turns  Esc=exit");
}
