...
Гарантии относятся к библиотечным операциям. Прямой доступ к возвращаемым WPF-объектам, собственные потоки и обработчики пользователя не изолированы. Сохранённые UI-объекты с пользовательскими делегатами могут удерживать сборку. Отписки Keyboard/Mouse и остановка Music реализуются отдельно на этапах 6–7.
