...
- **Кооперативная отмена выполнения**: длительные операции регулярно вызывают `StopManager.StopIfButtonPressed()`, что позволяет прервать воспроизведение кнопкой “Стоп”.
