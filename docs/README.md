...
### 5. Работа с мышью
- API для получения информации о позиции курсора на Canvas
- Отслеживание кликов мыши (одиночные и двойные, левая и правая кнопка)
- Отслеживание состояния нажатых кнопок мыши
...
{
    Console.WriteLine($"Мышь на позиции: {position.Value.X}, {position.Value.Y}");
}
```
